$(document).ready(function(){
    $('.swift').click(function(){
        ...
        if(signButton == 'Sign In'){
            ...
            $('.form_title').html('Log in'); // form title text change
            $('.b-subtext').html('or use your email account'); // form sub title text change
            $('.user_title').html('BARAKA COURT CHOKAA'); // user title text change
            ...
            $('.form_title').html('Sign Up');
            $('.b-subtext').html('or use your email for registration');
            $('.user_title').html('BARAKA COURT CHOKAA');
